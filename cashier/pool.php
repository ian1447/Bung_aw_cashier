                                    ...
                                    <div class="modal-body">
                                        ...
                                        <form class="needs-validation" method="POST">
                                            <div class="form-row">
                                                ...
                                                <div class="col-md-12 mb-2">
                                                    <label for="event_venue">Number of Adults(Above 13) ₱100</label>
                                                ...
                                                <div class="col-md-12 mb-2">
                                                    <label for="event_description">Number of Senior Citizen ₱50</label>
                                                    <input type="Number" class="form-control" id="no_of_senior" name="no_of_senior" autocomplete="off" placeholder="Enter Number of Senior Citizen" required>
                                                    <div class="valid-feedback">
                                                        Looks good!
                                                    </div>
                                                </div>
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <button class="btn btn-success" name="AddPool">Save</button>
                                            </div>
                                        </form>
                                        <?php
