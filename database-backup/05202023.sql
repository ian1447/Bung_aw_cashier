...
insert  into `memo`(`id`,`memo_number`,`from`,`date_created`,`date_from`,`date_to`,`subject`,`content`,`additional_info`,`is_void`) values (1,'0001','University President','2023-05-19','2023-05-16','2023-05-16','123b asdf','123adsaf','123asdf',0);
...
insert  into `memo_route`(`id`,`memo_id`,`faculty_name`) values (12,1,'Dr. Deanne Cameren Evangelista'),(13,1,'Dr. Edward Anuta');
